...
class NewDriverTab extends StatefulWidget {
  const NewDriverTab({super.key});

  @override
  State<NewDriverTab> createState() => _NewDriverTabState();
}

class _NewDriverTabState extends State<NewDriverTab> {
  final GlobalKey _showKey11 = GlobalKey();
  // final GlobalKey _showKey2 = GlobalKey();

  final GetStorage _getStorage = GetStorage();

  final String storageKey = "showcase_driver_home_tab";
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      if (isEnabled) {
        ...
        ShowCaseWidget.of(context).startShowCase([_showKey11]);
      }
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                right: 0,
                child: MyShowcase(
                  globalKey: _showKey11,
                  description:
                      'you can choose an available order to take it, choose a governorate to view orders in it'.tr,
                  enabled: isEnabled,
                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      ApplicationCard2(
                                                        ...
                                                        onTapCall: () {
                                                          showDialog(
                                                            context: context,
                                                            builder: (context) => callDialog(innerController
                                                                .currOrders.first.orderOwner!.phoneNumber),
                                                          );
                                                        },
                                                      ),
                                                    ],
                                                              ...
                                                              if (notification is UserScrollNotification) {
                                                                ...
                                                                if (offset <= 0) {
                                                                  ...
                                                                  if (!controller.hasReachedTopOnce) {
                                                                    ...
                                                                    controller
                                                                        .setContainerHeight(controller.baseHeight);
                                                                  }
                                                                }
                                                                return true; // handled
                                                              }
