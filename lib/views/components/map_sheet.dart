...
class MapSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    MapSelectorController mSC = Get.put(MapSelectorController(selectedPosition: selectedPoint));
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) async {
        ...
        mSC.searchEnabled ? mSC.toggleSearchState(false) : Get.back();
      },
      child: GetBuilder<MapSelectorController>(builder: (controller) {
        return Container(
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: MySearchField(
                                    ...
                                    onChanged: (s) => controller.triggerSearch(),
                                  ),
                                  // AuthField(
