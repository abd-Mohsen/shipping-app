                                            ...
                                            onTapRefuse: () {
                                              ...
                                              showDialog(
                                                ...
                                                builder: (context) => alertDialog(
                                                  onPressed: () {
                                                    Get.back();
                                                    controller.rejectOrderCustomer(
                                                        controller.order!.driversApplications[i].id);
                                                  },
                                                  title: "refuse the order?".tr,
                                                ),
                                                        ...
                                                        children: [
                                                          Expanded(
                                                            child: SheetDetailsTile(
                                                              ...
                                                              subtitle: Jiffy.parseFromDateTime(controller
                                                                      .order!.driversApplications[i].appliedAt)
                                        ...
                                        content: ApplicationCard2(
                                          ...
                                          onTapCall: () {
                                            showDialog(
                                              context: context,
                                              builder: (context) =>
                                                  callDialog(controller.order!.orderOwner!.phoneNumber),
                                            );
                                          },
                                        ),
                                      ),
                                                          ...
                                                          content: Column(
                                                            ...
                                                            children: [
                                                              DetailsTile(
                                                                ...
                                                                title: "full name".tr,
                                                                subtitle: controller
                                                                    .order!.paymentMethods[i].payment.fullName!,
                                                              ),
                                                              DetailsTile(
