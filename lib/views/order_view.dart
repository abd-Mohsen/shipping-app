    ...
    return GetBuilder<OrderController>(builder: (controller) {
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          actions: [
            if (oC.order != null && isCustomer && ["draft", "available".tr].contains(oC.order!.status)) //todo remove tr
              IconButton(
                onPressed: () {
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        ...
                                        style:
                                            tt.headlineMedium!.copyWith(color: cs.primary, fontWeight: FontWeight.bold),
                                        overflow: TextOverflow.ellipsis,
                                      ),
                                    ),
                                    Padding(
